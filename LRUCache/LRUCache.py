...
'''
Explanation:
In order to efficiently compute which is the least recently used key when the cache's capacity is full
we will mantain a queue that will store, in order, all the keys from least recently used to most recently used.
